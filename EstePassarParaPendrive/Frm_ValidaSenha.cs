...
namespace EstePassarParaPendrive
{
    public partial class Frm_ValidaSenha : Form
    {
        ...
        {
            ChecaForcaSenha verificar = new ChecaForcaSenha();
            ChecaForcaSenha.ForcaDaSenha forca;
            forca = verificar.GetForcaDaSenha(Txt_Senha.Text);
        ...
        private void Btn_VerSenha_Click(object sender, EventArgs e)
        {
            ...
            {
                Txt_Senha.PasswordChar = '\0'; //-> Aspas simples por que é um caracter e \0 significa vazio em C#
                VerSenhaTxt = true;
