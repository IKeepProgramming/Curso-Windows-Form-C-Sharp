...
namespace CursoWindowsForms
{
    public partial class Frm_Principal_Menu_UC : Form
    {
        ...
        private void abrirImagemToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            o.InitialDirectory = "C:\\Users\\Torme\\Desktop\\Curso-Windows-Form-C-Sharp\\Parte 2\\CursoWindowsForms - Baixado do Professor\\CursoWindowsForms\\Imagens";
            o.Filter = "PNG|*.PNG";
            o.Title = "Escolha a imagem: ";

            if(o.ShowDialog() == DialogResult.OK)
            {
                String nomeArquivo = o.FileName;
        ...
        {
            Frm_Questao q = new Frm_Questao("Frm_Question","Você deseja se desconectar?");
            q.ShowDialog();
